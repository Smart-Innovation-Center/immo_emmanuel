 ...
 */
final class Version20220208134352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transfer CHANGE etat etat VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transfer CHANGE etat etat JSON NOT NULL');
    }
}
